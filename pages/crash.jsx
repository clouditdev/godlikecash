...
const Crash = () => {
    return (
        <MainLayout>
            <div className='flex flex-col w-full z-10 md:mt-32'>
                    ...
                    <div className='flex w-full justify-center'>
                        <div className='flex md:flex-nowrap w-full md:w-3/4 mx-4 justify-between absolute invisible md:relative md:visible -top-80 -left-80 md:top-0 md:left-0'>
                            <div className='flex flex-nowrap bg-[#1E1E28] w-full h-14 rounded-md py-3 md:mr-2 justify-between'>
                                <input placeholder="0,00" className='w-16 focus:outline-none bg-[#1E1E28] text-white font-semibold text-xl mx-10' type="number" />
                                <div className='flex flex-nowrap mr-2'>
                                    ...
                                    <motion.p whileHover={{ y: -2 }} whileTap={{ y: 1 }} className='bg-[#6B7A99] hover:bg-[#7B8CB0] transition-colors duration-300 px-1 py-2 rounded-md text-sm mr-1 cursor-pointer'>
                                        max
                                    </motion.p>
                                </div>
                            </div>
                        ...
                        <div className='flex flex-col w-full md:w-3/4 mx-4 justify-between relative visible md:absolute md:invisible'>
                            <div className='flex flex-nowrap bg-[#1E1E28] w-full h-14 rounded-md py-3 md:mr-2 justify-between'>
                                <input placeholder="0,00" className='w-16 focus:outline-none bg-[#1E1E28] text-white font-semibold text-xl ml-2' type="number" />
                                <div className='flex flex-nowrap mr-2'>
                                    <motion.div whileHover={{ y: -2 }} whileTap={{ y: 1 }} className='bg-[#2C3037] rounded-md py-2 px-2 fill-[#6B7A99] mr-1 cursor-pointer'>
                                        <Delete />
                                    </motion.div>
                ...
                <div className='flex w-full justify-center'>
                <div className='flex bg-[#393A4F] md:w-3/4 w-full mx-4 rounded-md mb-36'>
