...
export const Settings = () => {
    ...
    return (
        <div>
            <button onClick={() => setSettings(true)} className='bg-[#2D2837] hover:bg-[#3e3f53] py-2 px-2 rounded-md cursor-pointer my-4 mx-4 transition-colors duration-200 fill-[#6B7A99] hover:fill-white'>
                <div>
                    <SettingsIcon />
                </div>
            </button>
                ...
                {settings ?
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { duration: 0.3 } }} exit={{ opacity: 0, transition: { duration: 0.3 } }} className="fixed top-0 left-0 pt-60 visible w-screen text-white transition-colors duration-300 h-screen bg-black bg-opacity-30 shadow-2xl drop-shadow-xl">
                        <div className="flex justify-center">
                            <div className="flex flex-col bg-[#343040] px-5 rounded-md">
                                ...
                                <div className="bg-[#1B1A1F] rounded-md mb-2">
                                    <p className="text-gray-400 font-semibold mx-4 my-4">
                                        Звуки сайта
                                    </p>
                                </div>
                                <div className="bg-[#1B1A1F] rounded-md mb-4">
                                    <p className="text-gray-400 font-semibold mx-4 my-4">
                                        Эффекты сайта
                                    </p>
                                </div>
